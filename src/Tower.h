...
struct Tower {
    ...
    Tower(sf::Vector2f const tile_center, unsigned const tile_size);
};

inline Tower::Tower(sf::Vector2f const tile_center, unsigned const tile_size)
    : shape(sf::TriangleFan)
{

    static std::vector<sf::Vector2f> const shape_pts = {
        { 0.70025, 0.0746216 },
        { 0.730252, 0.125041 },
        { 0.760254, 0.175461 },
        { 0.790256, 0.225881 },
