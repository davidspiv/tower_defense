...
Turret::Turret(const sf::Vector2f tile_center, const unsigned tile_size)
    : base_shape(sf::TriangleFan), fire_timer(100),
      center_of_home_tile(tile_center), barrel_shape(build_circle()),
      barrel_anchor(tile_center), barrel_rotation_speed(0.05f),
      barrel_ellipse_width(90.f), barrel_ellipse_height(45.f),
      barrel_angle(0.f) {

  const static std::vector<sf::Vector2f> base_shape_pts = {
      {1, 0.745007},          {0.990843, 0.797121},
      {0.964488, 0.843055},   {0.926444, 0.88006},
      {0.881982, 0.909156},   {0.834055, 0.932167},
      {0.78415, 0.950527},    {0.733035, 0.965212},
      {0.681142, 0.976858},   {0.628722, 0.985856},
      {0.575939, 0.992388},   {0.522904, 0.996385},
      {0.469737, 0.995967},   {0.416667, 0.992442},
      {0.363817, 0.986467},   {0.311315, 0.97797},
      {0.259344, 0.966676},   {0.208199, 0.952106},
      {0.158379, 0.933522},   {0.110794, 0.909827},
      {0.0671886, 0.879483},  {0.0308953, 0.840785},
      {0.00714522, 0.79345},  {0, 0.74097},
      {0.00228147, 0.687839}, {0.00786696, 0.634948},
      {0.0162233, 0.582423},  {0.0270923, 0.53036},
      {0.0403624, 0.478855},  {0.0560179, 0.428025},
      {0.0741149, 0.378012},  {0.0947685, 0.329002},
      {0.118145, 0.281232},   {0.144461, 0.235018},
      {0.17397, 0.190778},    {0.206948, 0.149064},
      {0.243654, 0.110598},   {0.284256, 0.0762813},
      {0.328729, 0.0471695},  {0.376725, 0.0243437},
      {0.427509, 0.00868394}, {0.480036, 0.000609117},
      {0.533182, 0},          {0.585854, 0.00704704},
      {0.636818, 0.022083},   {0.684873, 0.0447696},
      {0.729146, 0.0741745},  {0.769237, 0.109082},
      {0.80514, 0.148296},    {0.837087, 0.190802},
      {0.865408, 0.23581},    {0.890446, 0.282727},
      {0.912511, 0.331116},   {0.931866, 0.380654},
      {0.948715, 0.431099},   {0.963208, 0.482273},
      {0.975431, 0.534037},   {0.9854, 0.58628},
      {0.993032, 0.638916},   {0.998085, 0.69186}, // closed loop
  };
  ...
  for (std::size_t i = 0; i < base_shape.getVertexCount(); ++i) {
    base_shape[i].position -= {0.5f, 0.74f};
  }
